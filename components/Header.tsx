...
export default function Header({ isDark, setIsDark, saveStatus }: {
  ...
  return (
    <nav ref={navRef} className="bg-white dark:bg-slate-900/90 backdrop-blur-md border-b-2 border-slate-200 dark:border-slate-800 fixed top-0 left-0 right-0 z-[100]">
      {/* Barre principale */}
      <div className="max-w-[1600px] mx-auto px-4 md:px-6 py-2 flex justify-between items-center gap-4">
        ...
        <Link href="/" className="flex items-center gap-2.5 group cursor-pointer min-w-0 shrink">
          <div className="shrink-0 w-9 h-9 md:w-10 md:h-10 flex items-center justify-center transition-transform group-hover:scale-105 p-0.5">
            <Image
              src="/logo-icon.png"
              alt=""
              width={74}
          ...
          <span className="text-base md:text-xl font-800 text-slate-900 dark:text-white tracking-tighter truncate">
                ...
                <div className="pt-3 mt-2 border-t border-slate-100 dark:border-slate-800">
                  ...
                  <div className="mb-3 px-3">
                    ...
                    <ul className="space-y-1.5">
                      ...
                      <li className="flex items-center gap-2 text-[11px] text-slate-500 dark:text-slate-400">
                        <Check size={12} className="text-emerald-500 shrink-0" />
                        <span>Export PDF (comparateur et simulateur)</span>
                      </li>
                      <li className="flex items-center gap-2 text-[11px] text-slate-500 dark:text-slate-400">
                        <Check size={12} className="text-emerald-500 shrink-0" />
