  ...
  return (
    <main className="min-h-screen bg-page-settings">
      <PageSettingsPageHeader
        ...
        title="TJM → Revenu net"
        subtitle="Estimation du net selon le TJM et le nombre de jours (profil type : 1 part, charges moyennes, ACRE an 1)."
      />
        ...
        <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-lg border border-slate-100 dark:border-slate-700 overflow-hidden">
          ...
          <div className="p-6 space-y-4">
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400">
              Résultats avec un profil type (charges, véhicule, loyer, 1 part, ACRE an 1). Pour personnaliser, utilisez le <Link href="/comparateur" className="text-indigo-600 dark:text-indigo-400 hover:underline">comparateur</Link> ou le <Link href="/simulateur/sasu" className="text-indigo-600 dark:text-indigo-400 hover:underline">simulateur</Link>.
            </p>
