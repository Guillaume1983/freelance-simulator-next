...
export const metadata: Metadata = {
  ...
  description:
    'Comparez votre revenu net selon le statut : portage, micro-entreprise (auto-entrepreneur), EURL IR, EURL IS, SASU. Pour freelances et indépendants — projections sur plusieurs années, barèmes 2026.',
